    ...
    })(
        {
            ...
            8: [
                (require, module, exports) => {
                    ...
                    function removeNode(
                        ...
                        _.each(g.outEdges(entry.v), (edge) => {
                            var weight = g.edge(edge),
                                w = edge.w,
                                wEntry = g.node(w);
                            wEntry["in"] -= weight;
                    ...
                    function insertSelfEdges(g) {
                        ...
                        _.each(layers, (layer) => {
                            ...
                            _.each(layer, (v, i) => {
                                ...
                                _.each(node.selfEdges, (selfEdge) => {
                                    util.addDummyNode(
                                        g,
                                        "selfedge",
                                        {
                        ...
                        _.each(children, (child) => {
                            ...
                            var childNode = g.node(child),
                                ...
                                childBottom = childNode.borderBottom
                                    ...
                                    : child,
                                thisWeight = childNode.borderTop
                                    ? weight
                                    : 2 * weight,
                                minlen =
                ...
                (require, module, exports) => {
                    ...
                    function twoLayerCrossCount(g, northLayer, southLayer) {
                        ...
                        var southEntries = _.flatten(
                            _.map(northLayer, (v) => _.chain(g.outEdges(v))
                                    .map((e) => ({
                                            pos: southPos[e.w],
            ...
            17: [
                (require, module, exports) => {
                    ...
                    function sweepLayerGraphs(layerGraphs, biasRight) {
                        var cg = new Graph();
                        _.each(layerGraphs, (lg) => {
                            var root = lg.graph().root;
                            var sorted = sortSubgraph(lg, root, cg, biasRight);
                            _.each(sorted.vs, (v, i) => {
                                lg.node(v).order = i;
                            });
            ...
            18: [
                (require, module, exports) => {
                    ...
                    function initOrder(g) {
                        var visited = {},
                            simpleNodes = _.filter(g.nodes(), (v) => !g.children(v).length),
                            maxRank = _.max(
                                _.map(simpleNodes, (v) => g.node(v).rank),
                            ),
                ...
                (require, module, exports) => {
                    ...
                    function findType2Conflicts(g, layering) {
                        ...
                        function scan(
                            ...
                            var v;
                            _.each(_.range(southPos, southEnd), (i) => {
                                v = south[i];
                                if (g.node(v).dummy) {
                                    _.each(g.predecessors(v), (u) => {
                                        var uNode = g.node(u);
                                        if (
                                            uNode.dummy &&
                    ...
                    function findSmallestWidthAlignment(g, xss) {
                        return _.min(xss, (xs) => {
                            var min = _.min(xs, (x, v) => x - width(g, v) / 2),
                                max = _.max(xs, (x, v) => x + width(g, v) / 2);
                            return max - min;
                        });
                    }
            ...
            27: [
                (require, module, exports) => {
                    ...
                    function enterEdge(t, g, edge) {
                        ...
                        return _.min(candidates, (edge) => slack(g, edge));
                    }
                ...
                (require, module, exports) => {
                    ...
                    function longestPath(g) {
                        ...
                        function dfs(v) {
                            ...
                            visited[v] = true;
                            var rank = _.min(
                                _.map(g.outEdges(v), (e) => dfs(e.w) - g.edge(e).minlen),
                            );
            ...
            46: [
                (require, module, exports) => {
                    ...
                    Graph.prototype.setDefaultNodeLabel = function (
                        newDefault,
                    ) {
                    ...
                    Graph.prototype.setDefaultEdgeLabel = function (
                        newDefault,
                    ) {
                        if (!_.isFunction(newDefault)) {
                            newDefault = _.constant(newDefault);
                ...
                function (require, module, exports) {
                    (function (global) {
                        (function () {
                            ...
                            var reIsUint = /^\d+$/;
                            var reLatin1 =
                                /[\xc0-\xd6\xd8-\xde\xdf-\xf6\xf8-\xff]/g;
                            var reNoMatch = /($^)/;
                            ...
                            function runInContext(context) {
                                ...
                                function lazyClone() {
                                    ...
                                    result.__iteratees__ = arrayCopy(
                                        this.__iteratees__,
                                    );
                                    result.__takeCount__ = this.__takeCount__;
                                    result.__views__ = arrayCopy(
                                        this.__views__,
                                    );
                                    return result;
                                }
                                ...
                                function baseIsEqualDeep(
                                    ...
                                    stackB.push(other);
                                    var result = (
                                        objIsArr ? equalArrays : equalObjects
                                    )(
                                        object,
                                        other,
                                        equalFunc,
                                ...
                                function baseMatches(source) {
                                    ...
                                    return (object) => baseIsMatch(object, matchData);
                                }
                                ...
                                function composeArgs(args, partials, holders) {
                                    var holdersLength = holders.length,
                                        argsIndex = -1,
                                        argsLength = nativeMax(
                                            args.length - holdersLength,
                                            0,
                                        ),
                                        leftIndex = -1,
                                ...
                                function createCurry(flag) {
                                    function curryFunc(func, arity, guard) {
                                        if (
                                            guard &&
                                            isIterateeCall(func, arity, guard)
                                        ) {
                                            arity = undefined;
                                        }
                                ...
                                function createHybridWrapper(
                                    ...
                                    function wrapper() {
                                        ...
                                        if (isCurry || isCurryRight) {
                                            var placeholder =
                                                    wrapper.placeholder,
                                                argsHolders = replaceHolders(
                                                    args,
                                                    placeholder,
                                                );
                                            length -= argsHolders.length;
                                            if (length < arity) {
                                                var newArgPos = argPos
                                                        ? arrayCopy(argPos)
                                                        : undefined,
                                                    newArity = nativeMax(
                                                        arity - length,
                                ...
                                function createWrapper(
                                    ...
                                    if (!length) {
                                        bitmask &= ~(
                                            PARTIAL_FLAG | PARTIAL_RIGHT_FLAG
                                        );
                                ...
                                function getMatchData(object) {
                                    ...
                                    while (length--) {
                                        result[length][2] = isStrictComparable(
                                            result[length][1],
                                        );
                                    }
                                    return result;
                                ...
                                function invokePath(object, path, args) {
                                    ...
                                    var func =
                                        object == null ? object : object[path];
                                    return func == null
                                        ? undefined
                                ...
                                var difference = restParam(
                                    (array, values) => isObjectLike(array) &&
                                            isArrayLike(array)
                                            ? baseDifference(
                                                  array,
                                                  baseFlatten(
                                ...
                                var intersection = restParam((arrays) => {
                                ...
                                var union = restParam((arrays) => baseUniq(
                                        baseFlatten(arrays, false, true),
                                    ));
                                function uniq(
                                    array,
                                    isSorted,
                                    ...
                                    if (
                                        isSorted != null &&
                                        typeof isSorted != "boolean"
                                    ) {
                                        thisArg = iteratee;
                                        iteratee = isIterateeCall(
                                            array,
                                            isSorted,
                                            thisArg,
                                        )
                                ...
                                function unzipWith(array, iteratee, thisArg) {
                                    ...
                                    return arrayMap(result, (group) => arrayReduce(
                                            group,
                                            iteratee,
                                            undefined,
                                            true,
                                ...
                                var without = restParam(
                                    (array, values) => isArrayLike(array)
                                ...
                                var wrapperConcat = restParam(
                                    function (values) {
                                        values = baseFlatten(values);
                                        return this.thru((array) => arrayConcat(
                                                isArray(array)
                                                    ? array
                                                    : [toObject(array)],
                                                values,
                                ...
                                function wrapperReverse() {
                                    ...
                                    var interceptor = (value) => wrapped && wrapped.__dir__ < 0
                                            ? value
                                            : value.reverse();
                                ...
                                var forEachRight = createForEach(
                                    arrayEachRight,
                                    baseEachRight,
                                );
                                ...
                                var indexBy = createAggregator(
                                    (result, value, key) => {
                                        result[key] = value;
                                    },
                                );
                                var invoke = restParam(
                                ...
                                var reduce = createReduce(
                                    arrayReduce,
                                    baseEach,
                                );
                                var reduceRight = createReduce(
                                    arrayReduceRight,
                                    baseEachRight,
                                );
                                function reject(
                                    ...
                                    return func(
                                        collection,
                                        (value, index, collection) => !predicate(
                                                value,
                                                index,
                                                collection,
                                            ),
                                ...
                                function sortByOrder(
                                    ...
                                    if (
                                        guard &&
                                        isIterateeCall(iteratees, orders, guard)
                                    ) {
                                        orders = undefined;
                                    }
                                ...
                                var defer = restParam((func, args) => baseDelay(func, 1, args));
                                var delay = restParam(
                                    (func, wait, args) => baseDelay(func, wait, args),
                                );
                                var flow = createFlow();
                                ...
                                var partialRight =
                                    createPartial(PARTIAL_RIGHT_FLAG);
                                var rearg = restParam((func, indexes) => createWrapper(
                                        func,
                                        REARG_FLAG,
                                        undefined,
                                        undefined,
                                ...
                                var assign = createAssigner(
                                    (object, source, customizer) => customizer
                                            ? assignWith(
                                                  object,
                                                  source,
                                                  customizer,
                                ...
                                var defaultsDeep = createDefaults(
                                    merge,
                                    mergeDefaults,
                                );
                                ...
                                var omit = restParam((object, props) => {
                                    if (object == null) {
                                        return {};
                                    }
                                ...
                                var pick = restParam((object, props) => {
                                    if (object == null) {
                                        return {};
                                    }
                                ...
                                function endsWith(string, target, position) {
                                    ...
                                    return (
                                        position >= 0 &&
                                        string.indexOf(target, position) ==
                                            position
                                    );
                                }
                                ...
                                function startsWith(string, target, position) {
                                    ...
                                    return (
                                        string.lastIndexOf(target, position) ==
                                        position
                                    );
                                }
                                function template(
                                ...
                                function trunc(string, options, guard) {
                                    ...
                                    if (isRegExp(separator)) {
                                        ...
                                        string.indexOf(separator, end) != end
                                    ) {
                                        var index =
                                ...
                                var attempt = restParam((func, args) => {
                                    try {
                                ...
                                function matchesProperty(path, srcValue) {
                                    return baseMatchesProperty(
                                        path,
                                        baseClone(srcValue, true),
                                    );
                                }
                                var method = restParam((path, args) => (object) => invokePath(object, path, args));
                                var methodOf = restParam(
                                    (object, args) => (path) => invokePath(
                                                object,
                                                path,
                                                args,
                                            ),
                                ...
                                lodash.prototype.sample = function (n) {
                                    ...
                                    return this.thru((value) => sample(value, n));
                                };
