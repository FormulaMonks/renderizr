define("ace/mode/structurizr_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
...
define("ace/mode/structurizr", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    "ace/mode/text",
    "ace/mode/structurizr_highlight_rules",
    ...
    var ApacheConfHighlightRules =
        require("./structurizr_highlight_rules").MyNewHighlightRules;
...
(() => {
    window.require(["ace/mode/structurizr"], (m) => {
