        ...
        window.require.modules[id] = {
            ...
            factory: function () {
                var returnExports = factory.apply(
                    this,
                    deps.slice(0, factory.length).map((dep) => {
                        switch (dep) {
...
define("ace/anchor", [], (require, exports, module) => {
...
define("ace/document", [], (require, exports, module) => {
    ...
    (function () {
        ...
        this.clonePos = (pos) => ({ row: pos.row, column: pos.column });

        this.pos = (row, column) => ({ row: row, column: column });
...
define("ace/worker/mirror", [], (require, exports, module) => {
...
define("ace/mode/json_worker", [], (require, exports, module) => {
