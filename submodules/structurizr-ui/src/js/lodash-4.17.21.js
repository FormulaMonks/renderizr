...
(() => {
    ...
    var runInContext = function runInContext(context) {
        ...
        var baseSetToString = !defineProperty
            ? identity
            : ((func, string) => defineProperty(func, "toString", {
                      configurable: true,
                      enumerable: false,
        ...
        var getSymbols = !nativeGetSymbols
            ...
            : ((object) => {
                  ...
                  return arrayFilter(
                      ...
                      (symbol) => propertyIsEnumerable.call(object, symbol),
                  );
              });
        ...
        var setTimeout =
            ctxSetTimeout ||
            ((func, wait) => root.setTimeout(func, wait));
        ...
        var pullAt = flatRest((array, indexes) => {
            ...
            basePullAt(
                array,
                arrayMap(indexes, (index) => isIndex(index, length) ? +index : index).sort(compareAscending),
            );
         ...
         * // => [3]
         */
        var without = baseRest((array, values) => isArrayLikeObject(array)
         ...
         * // => ['a', 'b', 'c']
         */
        var rearg = flatRest((func, indexes) => createWrap(
                func,
                WRAP_REARG_FLAG,
                undefined,
                undefined,
        ...
        function transform(object, iteratee, accumulator) {
            ...
            (isArrLike ? arrayEach : baseForOwn)(
                object,
                (value, index, object) => iteratee(accumulator, value, index, object),
            );
            return accumulator;
        }
         ...
         * // => 'foo_bar'
         */
        var snakeCase = createCompounder((result, word, index) => result + (index ? "_" : "") + word.toLowerCase());
         ...
         * // => 'FOO BAR'
         */
        var upperCase = createCompounder((result, word, index) => result + (index ? " " : "") + word.toUpperCase());
