...
((factory) => {
    ...
    // `_listening` variable.
    var tryCatchOn = (obj, name, callback, context) => {
        try {
    ...
    _.extend(Collection.prototype, Events, {
        ...
        set: function (models, options) {
            ...
            if (set.length && replace) {
                orderChanged =
                    ...
                    _.some(this.models, (m, index) => m !== set[index]);
        ...
        _isModel: (model) => model instanceof Model,
    ...
    var addMethod = (base, length, method, attribute) => {
        switch (length) {
            case 1:
                return function () {
    ...
    var addUnderscoreMethods = (Class, base, methods, attribute) => {
    ...
    Backbone.ajax = () => Backbone.$.ajax.apply(Backbone.$, arguments);
    ...
    _.extend(History.prototype, Events, {
        ...
        decodeFragment: (fragment) => decodeURI(fragment.replace(/%25/g, "%2525")),
        ...
        start: function (options) {
            ...
            var addEventListener =
                ...
                ((eventName, listener) => attachEvent("on" + eventName, listener));
        ...
        stop: function () {
            ...
            var removeEventListener =
                ...
                ((eventName, listener) => detachEvent("on" + eventName, listener));
