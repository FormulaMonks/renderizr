...
structurizr.ui.Embed = function () {
    ...
    this.receiveStructurizrResponsiveEmbedMessage = (event) => {
        if (event === undefined) {
            return;
        }
...
window.addEventListener(
    "message",
    structurizr.embed.receiveStructurizrResponsiveEmbedMessage,
    false,
);
window.addEventListener(
    "resize",
