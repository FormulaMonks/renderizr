...
((global, factory) => {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : typeof define === "function" && define.amd
          ? define(["rgbcolor", "stackblur-canvas", "canvas"], factory)
          : (global.canvg = factory(
                global.RGBColor,
                global.StackBlur,
                global.Canvas,
            ));
})(this, (rgbcolor, stackblurCanvas, canvas) => {
    ...
    stackblurCanvas =
        stackblurCanvas && stackblurCanvas.hasOwnProperty("default")
            ...
            : stackblurCanvas;
    canvas =
        canvas && canvas.hasOwnProperty("default") ? canvas["default"] : canvas;
    ...
    var canvg_1 = createCommonjsModule((module) => {
        ...
        var matchesSelector;
            ...
            if (typeof Element == "undefined");
                ...
                matchesSelector = (node, selector) => node.matches(selector);
            } else if (
                typeof Element.prototype.webkitMatchesSelector != "undefined"
            ) {
                matchesSelector = (node, selector) => node.webkitMatchesSelector(selector);
            } else if (
                typeof Element.prototype.mozMatchesSelector != "undefined"
            ) {
                matchesSelector = (node, selector) => node.mozMatchesSelector(selector);
            } else if (
                typeof Element.prototype.msMatchesSelector != "undefined"
            ) {
                matchesSelector = (node, selector) => node.msMatchesSelector(selector);
            } else if (
                typeof Element.prototype.oMatchesSelector != "undefined"
            ) {
                matchesSelector = (node, selector) => node.oMatchesSelector(selector);
            } else {
                ...
                if (
                    ...
                    matchesSelector = (node, selector) => $(node).is(selector);
                }
        ...
        function build(opts) {
            ...
            // trim
            svg.trim = (s) => s.replace(/^\s+|\s+$/g, "");

            // compress non-ideographic spaces
            svg.compressSpaces = (s) => s.replace(/(?!\u3000)\s+/gm, " ");
            ...
            // length extensions
            svg.Property.prototype.getDPI = (viewPort) => {
                return 96.0; // TODO: compute?
            };

            svg.Property.prototype.getREM = (viewPort) => svg.rootEmSize;

            svg.Property.prototype.getEM = (viewPort) => svg.emSize;
            ...
            svg.Font = new (function () {
                ...
                this.Parse = (s) => {
                    ...
                    for (var i = 0; i < d.length; i++) {
                        if (!set.fontStyle && this.Styles.indexOf(d[i]) != -1) {
                            if (d[i] != "inherit") f.fontStyle = d[i];
                            set.fontStyle = true;
                        } else if (
                            !set.fontVariant &&
                            this.Variants.indexOf(d[i]) != -1
                        ) {
                            if (d[i] != "inherit") f.fontVariant = d[i];
                            set.fontStyle = set.fontVariant = true;
                        } else if (
                            !set.fontWeight &&
                            this.Weights.indexOf(d[i]) != -1
                        ) {
            ...
            svg.Element.ElementBase = function (node) {
                ...
                var normalizeAttributeName = (name) => {
                ...
                this.progress = function () {
                    ...
                    if (this.values.hasValue()) {
                        ...
                        ret.from = new svg.Property(
                            "from",
                            Number.parseFloat(this.values.value[lb]),
                        );
                        ret.to = new svg.Property(
                            "to",
                            Number.parseFloat(this.values.value[ub]),
                        );
                    ...
                    if (element != null) {
                        ...
                        if (element.type == "symbol") {
                            ...
                            tempSvg.attributes["preserveAspectRatio"] =
                                new svg.Property(
                                    "preserveAspectRatio",
                                    element.attribute("preserveAspectRatio")
                                        .value,
                                );
            ...
            svg.Element.feDropShadow = function (node) {
                ...
                this.apply = (ctx, x, y, width, height) => {
                    // TODO: implement
                };
            };
            ...
            svg.Element.feColorMatrix = function (node) {
                ...
                switch (
                    ...
                    case "hueRotate":
                        ...
                        var c = (m1, m2, m3) => m1 + Math.cos(a) * m2 + Math.sin(a) * m3;
                        matrix = [
                            c(0.213, 0.787, -0.213),
                            c(0.715, -0.715, -0.715),
                            c(0.072, -0.072, 0.928),
