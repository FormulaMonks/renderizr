...
!((e, t) => {
    ...
    var d = ((n) => {
        ...
        (se.contains = (e, t) => ((e.ownerDocument || e) != C && T(e), v(e, t))),
        (se.attr = (e, t) => {
    ...
    function Ze(e, t, n) {
        ...
        return (
            ((!v.boxSizingReliable() && i) ||
                ...
                "auto" === a ||
                (!Number.parseFloat(a) && "inline" === E.css(e, "display", !1, r))) &&
    ...
    E.extend({
        ...
        (E.cssHooks.marginLeft = _e(v.reliableMarginLeft, (e, t) => {
            if (t)
                return (
                    (Number.parseFloat(Be(e, "marginLeft")) ||
                        e.getBoundingClientRect().left -
                            Ie(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)) + "px"
                );
        })),
    ...
    E.fn.extend({
        ...
        (pt = {
            set: (e, t, n) => (!1 === t ? E.removeAttr(e, n) : e.setAttribute(n, n), n),
        }),
    ...
    E.fn.extend({
        ...
        E.each(["radio", "checkbox"], function () {
            (E.valHooks[this] = {
                ...
                v.checkOn ||
                    (E.valHooks[this].get = (e) => null === e.getAttribute("value")
                            ? "on"
                            : e.value);
        }),
    ...
    (Wt.href = Tt.href),
        E.extend({
            ...
            ajaxSetup: (e, t) => t ? Bt(Bt(e, E.ajaxSettings), t) : Bt(E.ajaxSettings, e),
            ajaxPrefilter: Ft(Rt),
            ajaxTransport: Ft(Mt),
            ajax: (e, t) => {
    ...
    E.ajaxSetup({
        ...
        E.ajaxPrefilter("json jsonp", (e, t, n) => {
            ...
            if (a || "jsonp" === e.dataTypes[0])
                return (
                    ...
                    (e.converters["script json"] = () => (o || E.error(r + " was not called"), o[0])),
                    (e.dataTypes[0] = "json"),
                    (i = C[r]),
                    (C[r] = () => {
                        o = arguments;
        ...
        (E.parseHTML = (e, t, n) => "string" != typeof e
                ? []
        ...
        (E.expr.pseudos.animated = (t) => E.grep(E.timers, (e) => t === e.elem).length),
        (E.offset = {
            setOffset: (e, t, n) => {
                var r,
                    i,
    ...
    (E.proxy = (e, t) => {
        ...
        (E.trim = (e) => null == e ? "" : (e + "").replace(Gt, "$1")),
