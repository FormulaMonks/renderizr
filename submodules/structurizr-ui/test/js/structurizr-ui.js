...
QUnit.test(
    "structurizr.ui.findElementStyle() finds the element style",
    (assert) => {
...
QUnit.test(
    "structurizr.ui.findElementStyle() finds the element style when there is a theme",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({
            model: {
                softwareSystems: [
...
QUnit.test(
    "structurizr.ui.findRelationshipStyle() finds the relationship style",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({
            model: {
                softwareSystems: [
        ...
        var relationshipStyle =
            structurizr.ui.findRelationshipStyle(relationship);
...
QUnit.test(
    "structurizr.ui.findRelationshipStyle() finds the relationship style when there is a theme",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({
            model: {
                softwareSystems: [
...
QUnit.test("getTitleForView() returns the view's title", (assert) => {
    const view = {
        title: "Title",
    };
...
QUnit.test(
    "getTitleForView() returns the computed name of a system landscape view (no enterprise name)",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({
            model: {},
        });
...
QUnit.test(
    ...
    (assert) => {
        ...
        assert.equal(
            structurizr.ui.getTitleForView(view),
            "[System Landscape] Enterprise",
        );
    },
);

QUnit.test(
    "getTitleForView() returns the computed name of a system context view",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({
            model: {
                softwareSystems: [
        ...
        assert.equal(
            structurizr.ui.getTitleForView(view),
            "[System Context] Software System 1",
        );
    },
);

QUnit.test(
    "getTitleForView() returns the computed name of a container view",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({
            model: {
                softwareSystems: [
        ...
        assert.equal(
            structurizr.ui.getTitleForView(view),
            "[Container] Software System 1",
        );
    },
);

QUnit.test(
    "getTitleForView() returns the computed name of a component view",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({
            model: {
                softwareSystems: [
        ...
        assert.equal(
            structurizr.ui.getTitleForView(view),
            "[Component] Software System 1 - Container 1",
        );
    },
);

QUnit.test(
    "structurizr.ui.getBranding() returns the default branding when no branding has been defined",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({});
...
QUnit.test(
    "structurizr.ui.getBranding() returns the workspace branding when specified",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({
            views: {
                configuration: {
...
QUnit.test(
    "structurizr.ui.getBranding() returns the theme branding when no workspace branding has been defined",
    (assert) => {
        structurizr.workspace = new structurizr.Workspace({});
        structurizr.ui.themes = [
            {
